...
export async function modifyEvent(id, {name, date, img, description}) {
    const update = {name, date, img, description};
    ...
    const updated = await Event.findByIdAndUpdate(id, update, {useFindAndModify: true}).exec();
