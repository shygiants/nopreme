    ...
    fields: {
        ...
        matches: {
            ...
            resolve: ({userId}, {filterByRegion, method, after, before, first, last}) => {
                ...
                return getMatchesForUser(userId, limit+1, filterByRegion, method).then(matches => {
...
const GraphQLNotice = new GraphQLObjectType({
    ...
    fields: {
        ...
        createdAt: {
            type: new GraphQLNonNull(GraphQLString),
            resolve: notice => moment(notice.createdAt).format('LLL'),
        }
    },
    interfaces: [nodeInterface],
});
...
export {
    GraphQLMatch,
    GraphQLMember, GraphQLItem, GraphQLGoods, GraphQLItemList, GraphQLEvent, GraphQLArtist, GraphQLUser, GraphQLCollection, GraphQLPosession, GraphQLWish, GraphQLExchange, GraphQLExchangeList, GraphQLNotice, GraphQLRegion, GraphQLAddress,
